...
export function About() {
    ...
    return (
        <section id="about" ref={aboutRef} className="w-full py-12 md:py-24 lg:py-32 bg-secondary text-secondary-foreground">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12 about-content overflow-x-hidden">
