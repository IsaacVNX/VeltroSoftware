...
export function Plans() {
    ...
    return (
        <section id="plans" ref={plansRef} className="w-full py-12 md:py-24 lg:py-32 bg-white flex flex-col justify-center min-h-screen">
            ...
            <div id="plans-container" className="plans-scroll-container flex flex-row md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 items-stretch w-full md:max-w-7xl md:mx-auto px-6 md:px-0 overflow-x-auto md:overflow-visible snap-x snap-mandatory pt-10 pb-12" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
